...
import org.qtproject.qt.bridge.generator.GeneratorEnvironment
...
internal class QtBridgeProcessor(
    ...
    private lateinit var classCreationEmitter: ClassCreationEmitter
    private lateinit var classMocJsonEmitter: ClassMocJsonEmitter
    private val qmlRegistrables = mutableListOf<RegistrableClass>()

    override fun process(resolver: Resolver): List<KSAnnotated> {
        val generatorEnv = GeneratorEnvironment(codeGenerator, resolver, logger)
        ...
        classCreationEmitter = ClassCreationEmitter(generatorEnv.codeGenerator)
        classMocJsonEmitter = ClassMocJsonEmitter(generatorEnv.codeGenerator)
